...
public class runnablelambda {
	public static void main(String[] args) {
      ...
      Runnable runnableLambdaSimple = () -> System.out.println("Inside Runnable 3");//for single statement no curlybraces needed
        ...
        new Thread(() -> System.out.println("Inside Runnable 4")).start();//simple way using lambda
